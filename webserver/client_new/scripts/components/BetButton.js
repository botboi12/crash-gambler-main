define([
  ...
  "components/Payout",
], function (React, Clib, StateLib, AppConstants, PayoutClass) {
  var D = React.DOM;
  ...
  return React.createClass({
    ...
    render: function () {
      ...
      var smallButton =
        this.props.isMobileOrSmall || this.props.controlsSize === "small";
      ...
      if (notPlayingOrBetting) {
        ...
        if (isBetting) {
          ...
          if (this.props.engine.gameState !== "STARTING") {
            btnContent.push(
              D.span({ key: "bc-0" }, smallButton ? "" : "Betting..."),
              D.a({ className: "cancel", key: "bc-1" }, " (Cancel)")
            );
          ...
          var btnText =
            canUserBet.message === "Not enough satoshis"
              ? smallButton
                ? "Bet"
                : "Bet too big"
              : smallButton
          ...
          if (invalidBet) {
            ...
            btnContent.push(
              D.span({ key: "bc-4" }, smallButton ? "Bet" : "Place bet")
            );
            btnClasses += " disable unselect";
            ...
            btnContent.push(
              D.span({ key: "bc-5" }, smallButton ? "Bet" : "Place bet")
            );
            btnClasses += " ";
        ...
        btnContent.push(
          D.div(
            { className: "btn-content", key: "bc-6" },
            D.span({ className: "cashout-cont" }, "Cash out"),
            D.span(
              { className: "cashout-amount-cont" },
              D.span(null, "@ "),
