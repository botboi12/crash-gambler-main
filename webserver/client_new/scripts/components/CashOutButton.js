define(["react", "game-logic/clib", "components/Payout"], function (
  React,
  Clib,
  PayoutClass
) {
    ...
    render: function () {
      if (this.props.engine.cashingOut) {
        return D.div(
          { className: "cash-out" },
          D.a(
            { className: "big-button-disable unclick" },
            "Cash out at ",
        ...
        return D.div(
          { className: "cash-out", onMouseDown: this._cashOut },
          D.a(
            { className: "big-button unclick" },
            "Cash out at ",
            Payout({ engine: this.props.engine }),
            " satoshis"
          )
