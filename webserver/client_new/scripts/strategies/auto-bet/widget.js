...
define(["react", "lib/react-radio"], function (React, ReactRadioClass) {
  ...
  return React.createClass({
    ...
    updateOnLossQty: function () {
      ...
      this.props.StrategyEditorActions.setWidgetState(
        "onLossIncreaseQty",
        amount
      );
    },
    ...
    render: function () {
      return D.div(
        { className: "auto-bet-container" },
        D.div(
          { className: "stra-base-bet" },
