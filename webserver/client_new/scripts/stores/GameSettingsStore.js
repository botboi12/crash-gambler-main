define([
  ...
  "lodash",
  "game-logic/clib",
], function (AppDispatcher, AppConstants, Events, _, Clib) {
  var CHANGE_EVENT = "change";

  var _themeFileName = "/css/blackTheme.css"; //Global var sent by the server

  /** Theme **/
  var _currentTheme = "black"; //black || white
